// Icon components — simple inline SVGs to avoid emoji
const Icon = {
  ...
  comment: (s=14) => <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>,
...
// App icon glyphs (filled, colored)
const AppIcon = {
  files: () => (
