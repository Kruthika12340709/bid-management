// Mock data for the Bid Management application
window.BID_DATA = (function() {
  ...
  const stages = [
    { key: 'validating', label: 'Validating', color: '#94A3B8' },
    { key: 'compiling',  label: 'Compiling', color: '#22D3EE' },
    { key: 'pending',    label: 'Pending Approval', color: '#5929d0' },
    { key: 'approved',   label: 'Approved', color: '#16A34A' },
    { key: 'submitted',  label: 'Submitted', color: '#CF008B' }
  ];
  ...
  const bids = [
    {
      id: 'BID-2026-041',
      title: 'NHS Digital — Clinical Data Platform',
      client: 'NHS Digital',
      rfp: 'RFP-NHS-2026-018',
      stage: 'pending',
      value: 1240000, currency: 'GBP',
      deadline: '2026-04-30T17:00:00Z',
      daysLeft: 5,
      assigned: 'director',
      sectionsComplete: 7, sectionsTotal: 8,
      flags: { lowConf: 2, conflicts: 1, missingRate: 0, highRisk: 2 },
      margin: 22, currentMargin: 24,
      compileTime: '14m 22s', winProb: 0.62, urgency: 'high',
      tags: ['Healthcare', 'High Value', 'EU-jurisdiction']
    },
    {
      id: 'BID-2026-040',
      title: 'BNP Paribas — KYC Automation Engine',
      client: 'BNP Paribas',
      rfp: 'RFP-BNP-2026-009',
      stage: 'compiling',
      value: 890000, currency: 'EUR',
      deadline: '2026-05-04T17:00:00Z',
      daysLeft: 9,
      assigned: 'manager',
      sectionsComplete: 4, sectionsTotal: 8,
      flags: { lowConf: 4, conflicts: 0, missingRate: 1, highRisk: 1 },
      margin: 25, currentMargin: 25,
      compileTime: 'in progress', winProb: 0.48, urgency: 'medium',
      tags: ['Financial Services', 'Compliance']
    },
    {
      id: 'BID-2026-039',
      title: 'Centrica — Smart Meter Field Ops',
      client: 'Centrica plc',
      rfp: 'RFP-CEN-2026-031',
      stage: 'validating',
      value: 2150000, currency: 'GBP',
      deadline: '2026-05-12T17:00:00Z',
      daysLeft: 17,
      assigned: 'manager',
      sectionsComplete: 0, sectionsTotal: 8,
      flags: { lowConf: 0, conflicts: 0, missingRate: 0, highRisk: 0 },
      margin: 20, currentMargin: 20,
      compileTime: '—', winProb: 0.55, urgency: 'low',
      tags: ['Utilities', 'High Value', 'Field Services']
    },
    {
      id: 'BID-2026-038',
      title: 'DHL Supply Chain — Predictive Routing',
      client: 'DHL Supply Chain',
      rfp: 'RFP-DHL-2026-002',
      stage: 'approved',
      value: 740000, currency: 'EUR',
      deadline: '2026-04-26T17:00:00Z',
      daysLeft: 1,
      assigned: 'director',
      sectionsComplete: 8, sectionsTotal: 8,
      flags: { lowConf: 0, conflicts: 0, missingRate: 0, highRisk: 0 },
      margin: 22, currentMargin: 23,
      compileTime: '11m 04s', winProb: 0.71, urgency: 'high',
      tags: ['Logistics', 'AI/ML']
    },
    {
      id: 'BID-2026-037',
      title: 'TfL — Passenger Flow Analytics',
      client: 'Transport for London',
      rfp: 'RFP-TFL-2026-014',
      stage: 'submitted',
      value: 615000, currency: 'GBP',
      deadline: '2026-04-15T17:00:00Z',
      daysLeft: -10,
      assigned: 'director',
      sectionsComplete: 8, sectionsTotal: 8,
      flags: { lowConf: 0, conflicts: 0, missingRate: 0, highRisk: 0 },
      margin: 24, currentMargin: 24,
      compileTime: '9m 47s', winProb: 0.66, urgency: 'low',
      tags: ['Public Sector', 'Submitted']
    },
    {
      id: 'BID-2026-036',
      title: 'Allianz — Claims Triage AI',
      client: 'Allianz Group',
      rfp: 'RFP-ALZ-2026-021',
      stage: 'pending',
      value: 1860000, currency: 'EUR',
      deadline: '2026-05-02T17:00:00Z',
      daysLeft: 7,
      assigned: 'director',
      sectionsComplete: 8, sectionsTotal: 8,
      flags: { lowConf: 1, conflicts: 0, missingRate: 0, highRisk: 3 },
      margin: 22, currentMargin: 22,
      compileTime: '16m 11s', winProb: 0.58, urgency: 'medium',
      tags: ['Insurance', 'High Value']
    },
    {
      id: 'BID-2026-035',
      title: 'Lloyds — Fraud Signal Aggregator',
      client: 'Lloyds Banking Group',
      rfp: 'RFP-LLD-2026-007',
      stage: 'compiling',
      value: 425000, currency: 'GBP',
      deadline: '2026-05-08T17:00:00Z',
      daysLeft: 13,
      assigned: 'manager',
      sectionsComplete: 5, sectionsTotal: 8,
      flags: { lowConf: 2, conflicts: 1, missingRate: 0, highRisk: 0 },
      margin: 23, currentMargin: 23,
      compileTime: 'in progress', winProb: 0.52, urgency: 'medium',
      tags: ['Financial Services']
    }
  ];

  // Detailed compiled sections (for the focused bid)
  const sections = [
  ...
  const commentary = [
    ...
    { time: '09:42', author: 'Compliance Lead', authorClass: 'compliance', text: 'IG steering for NHS DPO is on Tuesday — mitigation timing is realistic.' },
  ...
  // Dashboard timeseries — bids per week, win rate, value
  const timeseries = {
    weeks: ['W12','W13','W14','W15','W16','W17','W18'],
    submitted: [3, 4, 5, 4, 6, 5, 7],
    won: [1, 3, 2, 2, 4, 3, 5],
    value: [820, 1240, 1480, 1190, 1860, 1620, 2210] // £k
  };

  // Notifications widget on desktop
  const notifications = [
    ...
    { type: 'outcome',  title: 'AWARD — Sodexo Workplace Insights', sub: 'Win · GBP 720k · pricing data stored for calibration', time: '3h ago' }
  ];

  return { users, stages, stageProgress, bids, sections, pricingLines, risks, commentary, timeseries, notifications };
})();
